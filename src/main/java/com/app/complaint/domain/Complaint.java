...
public class Complaint extends AbstractModel {
	...
	public String toString() {
		return "Complain Id: " + complaintId + ", Status Type: " + complaintStatusType + ", Type" + complaintType
				+ ", TimeStamp:" + complaintTimeStamp + ", Title: " + complaintTitle + ", Body: " + complaintBody
				+ ", Picture: " + complaintPicture + ", Asignee Name:" + complaintPartnerAsigneeName;
	}
