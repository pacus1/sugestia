...
<div class="panel panel-default">
  ...
  <table class="table">
	...
	<form  action="/admin/listAllSuggestions/submit" method="POST"  role="form">
	<input type="radio" name="complaintStatusType" value="PENDING" checked> PENDING<br>
 						...
 						<input type="radio" name="complaintStatusType" value="SOLVED"> SOLVED<br>
 						<input type= "text" name= "complainId">
	        <input class="btn btn-sm btn-primary" style="color:#FFFFFF;" type="submit" value="Submit">
     </form>
