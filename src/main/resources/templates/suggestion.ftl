    		...
    		<div class="panel panel-default" style="text-align:left;">
			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
			    		...
			    		<input type="file" name="complaintPicture" accept="image/*" style="padding-top:10px; padding-bottom:10px;">
			    		<input type="file" name="complaintPicture" accept="image/*" style="padding-top:10px; padding-bottom:10px;"> 
                   	    <input type="file" name="complaintPicture" accept="image/*" style="padding-top:10px; padding-bottom:25px;"> 
