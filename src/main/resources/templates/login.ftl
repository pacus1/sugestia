			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
			    		...
			    		<input class="btn btn-lg btn-success btn-block btnlogin" style="color:#FFFFFF;" type="submit" value="Login">
                              ...
                              <a href="contnou"><button type="button" class="btn btn-lg btn-primary" style="margin-top:25px; color:#FFFFFF;  width:100%; margin-bottom:20px;">Inregistreaza un cont nou</button></a>
			    </div>
			</div>
		</div>
	</div>
